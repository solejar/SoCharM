...
#need to replace the input array with the array of denormalized characters
game = "LoL"
#fill characters
characters = io_tools.load_characters(game)
...
#need to see the results of the clustering before we can come up with names
#character_names = ['Support','Tank']
