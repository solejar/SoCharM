...
character_set = np.array([character['features'].values() for character in characters])
character_names = [character['name'] for character in characters]
#print np.array_str(character_set[2],precision=4)

adjusted_feature_dict = {}
for feature in feature_list:
    feature_vals = [character['feature'] for character in character_set]
    ...
    if(std):
        ...
        adjusted_feature_dict[feature] = adjusted_feature_vals
